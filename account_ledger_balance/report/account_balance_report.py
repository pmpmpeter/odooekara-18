...
class ParticularLedgerReport(models.AbstractModel):
    _name = 'report.account_ledger_balance.balance_report'
    ...
    def get_open_bal_debit(self, o):
        ...
        date1 = datetime.datetime.strptime(st_date, '%Y-%m-%d')
