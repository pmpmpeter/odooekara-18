...
class ChequeFormat(models.Model):
    ...
    def action_print_test(self):
        ...
        # return self.env.ref('odoo_print_cheque.cheque_test_print').report_action(self,data=data)
        return self.env.ref('odoo_print_cheque.test_cheque_action').report_action(self,data=data)
